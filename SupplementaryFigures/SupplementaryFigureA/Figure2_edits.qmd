...
Plot <- Utility_MarkerPlots2(data=data, panel=panel, myfactor="ptype", 
  ...
  filename="Vd2_Tetramer_Ptype_2", corral.width=0.8, width=12)
```
...
Plot <- Utility_MarkerPlots(data=data, panel=panel, myfactor="ptype", shape_palette = shape_ptype,
                            ...
                            filename="MAIT_Tetramer_Ptype", corral.width=0.8)
```
...
Plot <- Utility_MarkerPlots(data=data, panel=panel, myfactor="ptype", shape_palette = shape_ptype,
                            fill_palette = fill_ptype, XAxisLevels = XAxisLevels, savePlot=TRUE,
                            filterForThese = XAxisLevels, outpath=StorageLocation,
                            filename="NKT_Tetramer_Ptype", corral.width=0.8)
```
