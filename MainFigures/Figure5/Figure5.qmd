...
Plot <- Utility_MarkerPlots(data=data, panel=panel, myfactor="ptype", shape_palette = shape_ptype,
                            ...
                            filename="Vd2CD4_PMAAntibody_Ptype", corral.width=0.4,
...
Plot <- Utility_MarkerPlots(data=data, panel=panel, myfactor="ptype", shape_palette = shape_ptype,
                            fill_palette = fill_ptype, XAxisLevels = XAxisLevels, savePlot=FALSE,
                            filterForThese = XAxisLevels, outpath=StorageLocation,
                            filename="Vd2CD8_PMAAntibody_Ptype", corral.width=0.4,
                            style="individual", width=10)
...
Plot <- Utility_MarkerPlots(data=data, panel=panel, myfactor="ptype", shape_palette = shape_ptype,
                            fill_palette = fill_ptype, XAxisLevels = XAxisLevels, savePlot=FALSE,
                            filterForThese = XAxisLevels, outpath=StorageLocation,
                            filename="Vd2DN_PMAAntibody_Ptype", corral.width=0.4,
                            style="individual", width=10)
...
Plot <- Utility_MarkerPlots(data=data, panel=panel, myfactor="ptype", shape_palette = shape_ptype,
                            fill_palette = fill_ptype, XAxisLevels = XAxisLevels, savePlot=FALSE,
                            filterForThese = XAxisLevels, outpath=StorageLocation,
                            filename="Vd2T17_PMAAntibody_Ptype", corral.width=0.4,
                            style="individual", width=10)
...
Plot <- Utility_MarkerPlots(data=data, panel=panel, myfactor="ptype", shape_palette = shape_ptype,
                            fill_palette = fill_ptype, XAxisLevels = XAxisLevels, savePlot=FALSE,
                            filterForThese = XAxisLevels, outpath=StorageLocation,
                            filename="Vd2PD1_PMAAntibody_Ptype", corral.width=0.4,
                            style="individual", width=10)
